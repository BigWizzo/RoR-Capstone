...
ActiveRecord::Schema.define(version: 2021_01_29_180426) do
  ...
  create_table "clockings", force: :cascade do |t|
    ...
    t.index ["external_id"], name: "index_clockings_on_external_id"
    t.index ["internal_id"], name: "index_clockings_on_internal_id"
